...
// ✅ Gunakan upload.fields() supaya foto_buku & pdf_buku masuk ke req.files
...
// ========== TAMBAHAN: ROUTE KHUSUS FOTO (hanya admin) ==========
// Upload FOTO untuk buku
router.post('/:id/foto', authMiddleware, authorizeAdmin, upload.single('foto_buku'), bukuController.uploadFotoBuku);
// Hapus FOTO dari buku
router.delete('/:id/foto', authMiddleware, authorizeAdmin, bukuController.deleteFotoBuku);

// Update Foto dan PDF sekaligus
router.post('/:id/foto-pdf', authMiddleware, authorizeAdmin, uploadFields, bukuController.updateFotoPdfBuku);

// Delete Foto dan PDF sekaligus
router.delete('/:id/foto-pdf', authMiddleware, authorizeAdmin, bukuController.deleteFotoPdfBuku);
