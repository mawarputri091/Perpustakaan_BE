...
router.post('/', authMiddleware, upload.single('foto_buku'), bukuController.createBuku);
router.get('/', authMiddleware, bukuController.getAllBuku);
router.get('/:id', authMiddleware, bukuController.getBukuById);
router.put('/:id', authMiddleware, upload.single('foto_buku'), bukuController.updateBuku);
